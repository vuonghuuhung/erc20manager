...
const DAOItemCard: FC<{
  ...
  return (
    <div className="group h-[300px] relative overflow-hidden rounded-xl border border-gray-700/50 bg-gradient-to-b from-gray-900/90 to-gray-800/90 p-5 transition-all duration-300 hover:border-gray-600/50 hover:shadow-lg hover:shadow-blue-500/10">
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="space-y-2">
          <div className="flex w-full items-center justify-center gap-2 text-sm">
            <div className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-blue-500/10 px-2.5 py-1.5 text-blue-400">
              <IconBank />
              <span className="block w-[40px] truncate">
                {handleConvertToToken(totalSupply || 0)}
              </span>
              <span>{symbol}</span>
            </div>
          </div>
          ...
          <div className="flex w-full items-center justify-center gap-2 text-sm">
            <div className="flex w-full items-center justify-center gap-1.5 rounded-lg bg-purple-500/10 px-2.5 py-1.5 text-purple-400">
              <IconProposal />
