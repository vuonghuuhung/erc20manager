...
type ApproveProposalType = z.infer<typeof approveProposalSchema>;
...
const ApproveProposal = () => {
  ...
  async function onSubmit(values: ApproveProposalType) {
    try {
      ...
      setErrorWrite("");
      const { amount, spenderAddress, description } = values;
  ...
  return (
    <BoxContent extendClassName="p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-[#223354]">Approve Token</h2>
      </div>
